...
import { db } from ".";
import {
  expenseLimitBalanceView,
  expenselimitTable,
  ExpenseLimitWithCategoryView,
  InsertExpenseLimit,
  SelectExpenseLimit,
} from "../schema";
...
export async function updateDbExpenseLimit(
  id: SelectExpenseLimit["id"],
  limit: Partial<Omit<SelectExpenseLimit, "id">>
) {
  return db
